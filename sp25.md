...
<div style="border: 2px solid #4CAF50; padding: 20px; background-color: #E9F8E8;">
    ...
    <p style="font-size: 25px; color: #333;">Learn more about the Agentic AI Summit <a href="https://rdi.berkeley.edu/events/agentic-ai-summit" style="color: #4CAF50; font-weight: bold;">here</a>!</p>
    <p style="font-size: 25px; color: #333;">Learn more about the AgentX Competition <a href="https://rdi.berkeley.edu/agentx" style="color: #4CAF50; font-weight: bold;">here</a>!</p>
</div>
