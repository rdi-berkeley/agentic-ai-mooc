...
.past-moocs-dropdown .dropdown-btn {
...
.past-moocs-dropdown .dropdown-btn:hover {
  background-color: #45a049;
}
.past-moocs-dropdown .dropdown-content {
  display: none;
  position: absolute;
  right: 0;
...
.past-moocs-dropdown .dropdown-content a {
  color: #333;
  padding: 12px 16px;
...
.past-moocs-dropdown .dropdown-content a:hover {
  background-color: #f1f1f1;
}
.past-moocs-dropdown:hover .dropdown-content {
  display: block;
}
</style>

<div class="past-moocs-dropdown">
  <button class="dropdown-btn">Past Agentic AI MOOCs ▼</button>
  <div class="dropdown-content">
    <a href="https://agenticai-learning.org/f24">LLM Agents MOOC Fall 2024</a>
    <a href="https://agenticai-learning.org/sp25">Advanced LLM Agents MOOC Spring 2025</a>
  </div>
</div>
...
Course completion certificates will be awarded to students based on the rules of the following tiers. All assignments are due January 31th, 2026 at 11:59PM PDT. To receive your certificate, please complete the [Certificate Declaration Form](https://forms.gle/8KKAuwJKjbXRbnaU7) by January 31st, 2026 at 11:59PM PDT.
...
Submit your assignment via the [Learning & Sharing Assignment Submission Form](https://docs.google.com/forms/d/e/1FAIpQLSewktqNzf2xNZoDPfZ95e0vJAFFRgiR2nhe7AHJpXYfjO56mA/viewform).

### AgentX-AgentBeats Competition

More information about the project can be found at [AgentX-AgentBeats](https://rdi.berkeley.edu/agentx-agentbeats). The submission deadline is January 31th, 2026.
